...
export function PlayerCard() {
  ...
  const level = calculateLevel(userStats.lifetimeXp);
  const progress = getXpProgressPercent(userStats.lifetimeXp);
  const rank = calculateRank(userStats.lifetimeXp);
      ...
      <div className="flex items-center gap-6 relative z-10">
        ...
        <div className="flex-1 space-y-2">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-black text-slate-100 tracking-tight font-cursive">{userStats.name}</h2>
            <span className={cn(
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-1 px-2 py-0.5 bg-amber-500/5 rounded-full border border-amber-500/10">
            ...
            <div className="flex items-center gap-1 px-2 py-0.5 bg-purple-500/5 rounded-full border border-purple-500/10">
              <Trophy className="w-3 h-3 text-purple-500/60" />
            ...
            <div className={cn(
              ...
              <Plus className={cn("w-3 h-3", (userStats.balance || 0) < 0 ? "text-red-500/60" : "text-emerald-500/60")} />
              <span className={cn(
